...
class RBNode {
    ...
    _insert(key,value,tree) {
        if(key <= this.key && !this.left) {
            console.log('Inserting Left at: ', this.key);
            const node = new RBNode(key,value,this, tree);
            this.left = node;
            return node;
        } else if(key >= this.key && !this.right) {
            console.log('Inserting Right at: ', this.key)
            const node = new RBNode(key,value,this,tree);
            this.right = node;
            return node;
